        ...
        <v-form v-model="valid" ref="form">
          ...
          <v-row>
            <v-col cols="12" md="4">
              <v-select
                label="คำนำหน้าชื่อ"
                v-model="prescription.titlenameId"
                :items="titlename"
                item-text="titlename"
                item-value="id"
          ...
          <v-col>
            <v-select
              label="แพทย์ผู้สั่งยา"
              v-model="prescription.doctornameId"
              :items="doctorname"
      ...
      <v-col>
        ...
        <v-row justify="center">
          ...
          <v-col cols="12" md="6">
            <v-text-field
              block
              label="ชื่อยา"
              v-model="prescription.drugname_s"
        ...
        <v-row justify="center">
          ...
          <v-col cols="8" md="2">
            <v-select
              label="หน่วยของยา"
              v-model="prescription.unit_of_medicineId"
              :items="unit"
              item-text="unit"
              item-value="id"
              :rules="[(v) => !!v || 'กรุณาเลือกข้อมูล']"
                ...
                <v-row justify="center">
                  <v-bottom-sheet v-model="sheet">
                    <template v-slot:activator="{ on }">
                      <v-btn color="green" dark v-on="on">รายละเอียดใบสั่งยา</v-btn>
                    </template>
      ...
      http
        .post(
          "/prescription/" +
            ...
            "/" +
            this.prescription.titlenameId +
            "/" +
            this.prescription.name +
            "/" +
            this.prescription.age +
            "/" +
            this.prescription.drugallergy +
            "/" +
            this.prescription.doctornameId +
            "/" +
            this.prescription.Drug_id +
            "/" +
